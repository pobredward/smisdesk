      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">{camp.description}</p>
          </div>
        </div>
      </div>
        ...
        <section className="space-y-12">
          ...
          <div id="registration" className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="prose max-w-none">
              ...
              <div className="mt-6 grid md:grid-cols-2 gap-4">
                <Link
                  href={`/camp/${id}/registration`}
                  className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors border border-blue-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">📝 등록 절차</h4>
                  <p className="text-sm text-gray-600">단계별 등록 방법 안내</p>
                </Link>
                <Link
                  href={`/camp/${id}/registration/documents`}
                  className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors border border-blue-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">📄 필요 서류</h4>
                  <p className="text-sm text-gray-600">준비해야 할 서류 목록</p>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div id="program" className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="prose max-w-none">
              ...
              <div className="mt-6 grid md:grid-cols-3 gap-4">
                <Link
                  href={`/camp/${id}/program/classes`}
                  className="block p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">📚 수업</h4>
                  <p className="text-sm text-gray-600">원어민 & 멘토 수업</p>
                </Link>
                <Link
                  href={`/camp/${id}/program/activities`}
                  className="block p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">🎯 액티비티</h4>
                  <p className="text-sm text-gray-600">다양한 활동 프로그램</p>
                </Link>
                <Link
                  href={`/camp/${id}/program/schedule`}
                  className="block p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors border border-green-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">📅 일정</h4>
                  <p className="text-sm text-gray-600">하루 일과표</p>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div id="accommodation" className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="prose max-w-none">
              ...
              <div className="mt-6 grid md:grid-cols-2 gap-4">
                <Link
                  href={`/camp/${id}/accommodation/rooms`}
                  className="block p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors border border-orange-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">🏠 숙소 정보</h4>
                  <p className="text-sm text-gray-600">방 구성 및 시설 안내</p>
                </Link>
                <Link
                  href={`/camp/${id}/accommodation/meals`}
                  className="block p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors border border-orange-200"
                >
                  <h4 className="font-semibold text-gray-900 mb-2">🍽️ 식사</h4>
                  <p className="text-sm text-gray-600">식단 및 식사 시간</p>
                </Link>
              </div>
            </div>
          </div>
